...
Hair Routine is built to keep your data on your device. Your products,
...
- Hair type and goals you selected during onboarding
- Display name (if you choose to enter one)
- Products you add, including ingredients you provide
- Wash day, treatment, refresh, and custom routines
- Daily check-ins (which routine days you marked done, per-product usage,
  streak freezes used)
...
When you make a purchase inside Hair Routine, the transaction is processed
...
- We do not analyze your progress photos. The on-screen oval is a positioning
  guide only — there is no face scan, hair scan, or hair analysis.
- We do not give medical advice. Ingredient flags are organizational
...
- **Camera** — to capture progress photos for the journal. The camera feed is
  processed locally and never streamed off-device.
- **Photo library** — only when you pick a photo for the journal.
- **Notifications** — for wash-day reminders, per-product reminders (Premium),
  and custom routine reminders (Premium). All schedules are local. You can
  disable any of these in the app's Reminders screen.

## Children

Hair Routine is not directed to children under 13. We do not knowingly
...
[hairroutine@omegion.dev](mailto:hairroutine@omegion.dev) and we will
